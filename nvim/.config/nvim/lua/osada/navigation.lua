...
-- TODO: não estou usando mais essa função. Remover das próximas versões <29-08-21, Alexandre> --
vim.g.qf_value = 0;
vim.g.lf_value = 0;
...
vim.api.nvim_set_keymap('n', '<leader>qk', ':cprev<CR>', { noremap=true, silent=true })
